...
export default function ProfileImage({ src, fallbackSrc, alt, width, height, className = "" }: ProfileImageProps) {
  ...
  return (
    <div className={`relative overflow-hidden ${className}`} style={{ width: `${width}px`, height: `${height}px` }}>
      ...
      <img
        ...
        onError={(e) => {
          console.error("Error loading image in render:", (e.target as HTMLImageElement).src)
