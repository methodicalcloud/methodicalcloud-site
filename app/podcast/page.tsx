  ...
  const initialTopics = [
    {
      ...
      description:
        'Breaking down common mistakes in automation diagrams and providing practical solutions.',
      duration: '12 min',
      status: 'coming soon',
    },
    {
      ...
      description:
        'Exploring the hidden costs and technical debt that accumulate when design is overlooked.',
      duration: '15 min',
      status: 'coming soon',
    },
    {
      ...
      description:
        'How context switching impacts productivity and what you can do about it.',
      duration: '10 min',
      status: 'coming soon',
    },
    {
      ...
      description:
        'Security principles from high-security systems applied to everyday automation.',
      duration: '13 min',
      status: 'coming soon',
    },
    {
      ...
      description:
        'Reimagining technical meetings with diagrams at the center of communication.',
      duration: '11 min',
      status: 'coming soon',
    },
  ]
    ...
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                <em>Diagram the Damn Thing</em> is a short-format,
                insight-packed podcast from Methodical Cloud. Each episode
                focuses on breaking down complex automation concepts, systems
                thinking, or technical leadership challenges—with visuals in
                mind.
              </p>
              <p className="text-gray-300 mb-4">
                This podcast is rooted in the belief that great automation
                starts with clarity, and that clarity often begins with a
                diagram.
              </p>
              <p className="text-gray-300 mb-4">
                Hosted by Larry Smith Jr., each episode is 10–15 minutes long,
                making it perfect for your commute or coffee break.
              </p>
              <div className="flex items-center mt-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Every episode is driven by a diagram
                  </p>
                </div>
              </div>
      ...
      <section className="py-16 bg-navy-900">
        <div className="container-custom">
          ...
          <p className="section-subtitle text-center">
            Each episode follows a consistent format designed to maximize
            clarity and insight
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mt-12">
            <div className="card p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">
                Name, tagline, quick theme setup
              </p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">
                Diagram explained, use case broken down
              </p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">
                What matters, what to watch out for
              </p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">
                Takeaway or principle of the day
              </p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">
                View diagram, submit questions, explore blog
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container-custom">
          ...
          <p className="section-subtitle text-center">
            The first episodes of Diagram the Damn Thing are currently in
            production
          </p>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-300 mb-4">
                Every episode of Diagram the Damn Thing is accompanied by a
                visual diagram that will be stored in our "Flow Crimes" visual
                archive.
              </p>
              <p className="text-gray-300 mb-4">
                These diagrams serve as both learning tools and reference
                materials, helping you understand complex concepts at a glance.
              </p>
              <p className="text-gray-300 mb-6">
                The archive will grow with each episode, creating a valuable
                resource for automation enthusiasts, system designers, and
                technical leaders.
              </p>
              <Link
                href="/diagrams"
        ...
        <div className="container-custom">
          <div className="bg-navy-800 rounded-xl border border-navy-700 p-8 md:p-12 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Subscribe to be notified when the first episodes of Diagram the
              Damn Thing are released. Follow us on{' '}
              <a
